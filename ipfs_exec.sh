...
# substitute our bootstrap
sed -i 's/104.131.131.82/192.170.227.195/' $IPFS_CONFIG
sed -i 's/QmaCpDMGvV2BGHeYERUEnRQAwe3N8SzbUtfsmvsqQLuvuJ\"\,/QmZ16VzkPnyTCLqPdV2LiKZXJutn8mAHtG34vi6HiLmftE\"/' $IPFS_CONFIG
